...
#ifndef MINDSPORE_CCSRC_BACKEND_COMMON_SOMAS_SOMAS_SOLVER_CORE_H_
#define MINDSPORE_CCSRC_BACKEND_COMMON_SOMAS_SOMAS_SOLVER_CORE_H_
...
class SomasSolverCore {
 public:
  ...
  [[nodiscard]] const size_t &GetUpperbound() const { return upperbound_; }

  [[nodiscard]] const size_t &Getlifelongmemory() const { return lifelong_memory_; }
 ...
 private:
  ...
  static void Destroy(std::shared_ptr<FootPrint> *pFootprint);
};
}  // namespace mindspore::somas

#endif  // MINDSPORE_CCSRC_BACKEND_COMMON_SOMAS_SOMAS_SOLVER_CORE_H_
