...
inline int SizeToInt(size_t u) {
  if (u > static_cast<size_t>((std::numeric_limits<int>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The size_t value(" << u << ") exceeds the maximum value of int."
              << std::endl;
  }
...
inline uint32_t SizeToUint(size_t u) {
  if (u > static_cast<size_t>((std::numeric_limits<uint32_t>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The size_t value(" << u << ") exceeds the maximum value of uint32_t."
              << std::endl;
  }
...
inline int64_t SizeToLong(size_t u) {
  if (u > static_cast<size_t>((std::numeric_limits<int64_t>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The size_t value(" << u << ") exceeds the maximum value of int64_t."
              << std::endl;
  }
...
inline size_t IntToSize(int u) {
  if (u < 0) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The int value(" << u << ") is less than 0." << std::endl;
  }
...
inline size_t LongToSize(int64_t u) {
  if (u < 0) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The int64_t value(" << u << ") is less than 0." << std::endl;
  }
  return static_cast<size_t>(u);
}
...
inline uint32_t LongToUint(int64_t u) {
  ...
  if (u > static_cast<int64_t>((std::numeric_limits<uint32_t>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The int64_t value(" << u << ") exceeds the maximum value of uint32_t."
              << std::endl;
  }
  return static_cast<uint32_t>(u);
}
...
inline size_t FloatToSize(float u) {
  if (u < 0) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The float value(" << u << ") is less than 0." << std::endl;
  }

  if (u > static_cast<float>((std::numeric_limits<size_t>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The float value(" << u << ") exceeds the maximum value of size_t."
              << std::endl;
  }
  return static_cast<size_t>(u);
}
...
inline int FloatToInt(float u) {
  if (u > static_cast<float>((std::numeric_limits<int>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The float value(" << u << ") exceeds the maximum value of int."
              << std::endl;
  }
  return static_cast<int>(u);
}
...
inline int FloatToLong(float u) {
  if (u > static_cast<float>((std::numeric_limits<int64_t>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The float value(" << u << ") exceeds the maximum value of int64_t."
              << std::endl;
  }
  return static_cast<int64_t>(u);
}
...
inline int64_t DoubleToLong(double u) {
  if (u > static_cast<double>((std::numeric_limits<int64_t>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The double value(" << u << ") exceeds the maximum value of int64_t."
              << std::endl;
  }
  return static_cast<int64_t>(u);
}
...
inline uint32_t IntToUint(int32_t u) {
  if (u < 0) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The int32_t value(" << u << ") is less than 0." << std::endl;
  }
  return static_cast<uint32_t>(u);
}
...
inline int32_t UintToInt(uint32_t u) {
  if (u > static_cast<uint32_t>((std::numeric_limits<int32_t>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The uint32_t value(" << u << ") exceeds the maximum value of int32_t."
              << std::endl;
  }
...
inline int64_t UlongToLong(uint64_t u) {
  if (u > static_cast<uint64_t>((std::numeric_limits<int64_t>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The uint64_t value(" << u << ") exceeds the maximum value of int64_t."
              << std::endl;
  }
  return static_cast<int64_t>(u);
}
...
inline unsigned int UlongToUint(uint64_t u) {
  if (u > static_cast<uint64_t>((std::numeric_limits<unsigned int>::max)())) {
    std::cout << "--INTERNAL_EXCEPTION-- " << "The size_t value(" << u << ") exceeds the maximum value of unsigned int."
              << std::endl;
  }
...
inline int IntMulWithOverflowCheck(int a, int b) {
  ...
  if (a != 0) {
    ...
    if (overflow) {
      std::cout << "--EXCEPTION-- " << "Mul: a(" << a << ") * b(" << b << ") result is overflow" << std::endl;
    }
  }
  return out;
}
...
inline size_t SizetAddWithOverflowCheck(size_t x, size_t y) {
  size_t sum = x + y;
  if (sum < x || sum < y) {
    std::cout << "--EXCEPTION-- " << "Add: a(" << x << ") + b(" << y << ") result is overflow" << std::endl;
  }
  return sum;
}
